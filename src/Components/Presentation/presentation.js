...
function Presentation(props) {
    ...
    return (
        <div className='h-[100vh] w-[100%] pt-[5rem] flex flex-col justify-center items-center'>
            <p className='mytext text-gray-300 dark:text-black text-[25px] md:text-[30px] DancingScript font-bold backdrop-blur-md 
            ...
            <h4 className='mytext text-gray-300 dark:text-black text-[25px] md:text-[30px] DancingScript font-bold backdrop-blur-md 
