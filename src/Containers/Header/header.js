...
function Header(props) {
    ...
    const DropClasses = `absolute bg-transparent backdrop-blur-xl backdrop-brightness-150 right-0 dark:backdrop-brightness-75
    ...
    return (
        <div className='h-[3rem] md:h-[5rem] w-[100%] fixed backdrop-blur-md backdrop-brightness-150 dark:backdrop-brightness-75 flex 
        justify-between items-center px-5 duration-75 dark:duration-75'>
            ...
            <Transition in={showDropMenu} timeout={300} mountOnEnter unmountOnExit>
                <div className={DropClasses}>
                    <p className=' px-[1rem] py-[0.3rem] text-[13px] text-darkLighterBlue dark:text-gray-500 flex justify-start'>
                        {t('programB')} <NewspaperIcon className='text-darkLighterBlue dark:text-gray-500 w-[1rem]'/>
                    </p>
