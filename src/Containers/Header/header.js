...
function Header(props) {
    ...
    const DropClasses = `absolute header backdrop-blur-md backdrop-brightness-150 dark:backdrop-brightness-75 right-0 
    ...
    return (
        <div className='header h-[3rem] md:h-[5rem] w-[100%] fixed backdrop-blur-md backdrop-brightness-150 dark:backdrop-brightness-75 flex 
        justify-between items-center px-5 duration-75 dark:duration-75'>
            ...
            <div className='hidden md:flex w-[30%] h-[90%] justify-evenly items-center rounded-md'>
                <p className='font-semibold text-darkLighterBlue cursor-pointer duration-75 hover:duration-75 hover:text-specialPink 
                hover:underline'>Programme</p>
                <button className='h-[100%] px-[1rem] font-semibold bg-transparent text-darkLighterBlue hover:bg-darkLighterBlue hover:text-white 
                duration-75 dark:duration-75 rounded-lg'>
                    Administrateur
                </button>
                <div className='hidden w-[3rem] md:w-[4rem] h-[1.7rem] md:h-[2rem] bg-darkLighterBlue dark:bg-white rounded-full 
            ...
            <Transition in={showDropMenu} timeout={300} mountOnEnter unmountOnExit>
                <div className={DropClasses}>
                    <p className=' px-[1rem] py-[0.3rem] text-[13px] text-darkLighterBlue dark:text-white flex justify-start'>
                        Programme <NewspaperIcon className='text-darkLighterBlue dark:text-white w-[1rem]'/>
                    </p>
                    <p className='bg-white dark:bg-darkLighterBlue dark:text-white rounded-lg text-[13px] px-[1rem] py-[0.3rem] flex justify-start'>
                        Administrateur <UserIcon className='text-specialPink w-[1rem]'/></p>
                </div>
            </Transition>
        </div>
    );
